...
public class SimpleLogo extends JFrame implements ActionListener,Observer {
	...
	public void proc3() {
        ...
        public void proc8() {
            ...
            JeuEquipe jeu2 = new JeuEquipe();
            jeu2.addObserver(this);
            for(Tortue t : jeu2.getJoueuses()) {
                feuille.addTortue(t);
            }
            feuille.addTortue(jeu2.getBalle());
